(defproject config-testing "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "config-testing.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main config-testing.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "config-testing.core/on-figwheel-reload"}

                :compiler {:main config-testing.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/config_testing.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main config-testing.test-runner
                           :optimizations :none}}
